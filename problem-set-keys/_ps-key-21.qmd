...
```{r}
#| label: plot-peak-sig
#| fig.alt: "Line plot of negative log10 p-values across a region of chromosome II, with a red horizontal threshold line at 20."
ggplot(
...
Biostrings::writeXStringSet(peak_seqs, here("data/block-dna/reb1_peaks.fasta"))
