...
#| fig.alt: "Histogram of MNase-seq fragment lengths at single-base resolution, with blue vertical lines marking the subnucleosomal, mononucleosomal, and dinucleosomal peaks."
ggplot(
  mnase_tbl,
  aes(x = end - start)
) +
...
```{r}
#| fig.alt: "Line plots of the number of intersecting fragments against position relative to +1 nucleosome midpoints, faceted by fragment type."
ggplot(
  all_tbl,
  aes(win_ids, n)
) +
