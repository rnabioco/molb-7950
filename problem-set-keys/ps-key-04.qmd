...
The green line indicates a perfect correlation, and the blue line is the linear model fit of the data. The Spearman correlation is `rna_prot_cor`, indictating a strong positive correlation. One way to think about this is that there are `rna_prot_cor` proteins made per 1 mRNA.
