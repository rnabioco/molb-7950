...
metadata <- data.frame(
  sample_id = list.files(here("data/block-rna/differentiation_salmonouts"),
    pattern = "^DIV"
  ),
  salmon_dirs = list.files(here("data/block-rna/differentiation_salmonouts"),
    recursive = T,
    pattern = ".gz$",
    full.names = T
  )
...
#| fig.alt: "Notched box plots of log2 fold change (DIV28 over DIV0) for genes grouped as none, axonogenesis, or cell cycle, with a dashed reference line at zero."
