...
```{r}
#| fig.alt: "Density plot of height with a vertical reference line at 75."
ggplot(
  data = j,
  aes(x = height)
) +
...
```{r}
#| label: plot
#| fig.alt: "Jittered points of fraction against sample size, faceted by test type, with black diamonds marking group means and dashed reference lines at 0.5 and 0.9."
