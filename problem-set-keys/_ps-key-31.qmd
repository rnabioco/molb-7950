...
The datasets have been processed with `alevin`, and the output is here `data/block-rna/scrna/aml/alevin/`. 
...
library(tximport)
library(here)
day0 <- tximport(here("data/block-rna/scrna/aml/alevin/day0/alevin/quants_mat.gz"), type = "alevin")
day2 <- tximport(here("data/block-rna/scrna/aml/alevin/day2/alevin/quants_mat.gz"), type = "alevin")
