...
sched_tbl <- read_tsv(here("data/syllabus.tsv")) |>
  ...
  mutate(
    ...
    page_html = path("pages", glue("class-{block_num}.html")),
    slides_html = path("slides", glue("class-{block_num}.html")),
    ex_html = path("exercises", glue("class-{block_num}.html")),
    hw_html = path("problem-sets", glue("class-{block_num}.html")),
    hw_key_html = path("problem-set-keys", glue("class-{block_num}.html")),
  ) |>
  mutate(
    # page links
    page_link = case_when(
