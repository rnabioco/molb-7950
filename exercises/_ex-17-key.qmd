...
#| warning: false
#| output-location: column
#| fig.alt: "Histograms of fragment length in base pairs at single-base resolution, faceted by assay (MNase-seq and ATAC-seq), spanning 30 to 500 bp."
acc_tbl <-
  bind_rows(
...
```{r}
#| fig.alt: "Autocorrelation of fragment-length density against lag, with vertical red lines marking lags of 10 and 21 bp."
...
```{r}
#| fig.alt: "Autocorrelation of ATAC-seq fragment lengths against lag, with vertical red lines at lags of 10 and 21 bp."
...
#| fig.alt: "Side-by-side autocorrelation plots for ATAC-seq and MNase-seq fragment lengths, each with vertical red lines at lags of 10 and 21 bp."
