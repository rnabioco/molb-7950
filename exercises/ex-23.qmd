...
#| label: choosemart
#| eval: false
mart <- biomaRt::useEnsembl("??", host = "https://www.ensembl.org")
```
...
#| eval: false
#| fig.alt: "Scatter plot comparing log-transformed TPM values between two DIV-8 replicates, annotated with the Spearman correlation coefficient."
...
#| output-location: slide
#| eval: false
#| fig.alt: "Scatter plot comparing log10 TPM values between two DIV-8 replicates after filtering to genes with at least 1 TPM in both, annotated with the Spearman correlation coefficient."
