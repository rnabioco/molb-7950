...
#| fig.alt: "Density curves of percent-spliced-in values by sample and condition, faceted by whether the event is significant."
...
#| label: pca-psis
#| output-location: slide
#| fig.alt: "PCA scatter plot of percent-spliced-in values, with samples colored and shaped by knockdown condition and axes labeled with percent variance explained."
