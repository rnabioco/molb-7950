...
THe **Bootcamp block** covers the basics of shell and R programming, and introduces important statistical concepts and approaches. We will also cover the basics of data types you will encounter during biological data analysis and approaches for their analysis.
...
Classes begin on August 28 and end December 1. Dates are from the [Fall 2023 Academic Calendar](https://www.cuanschutz.edu/registrar/academic-calendars/2022-2023).
...
Your attendance in person is required. Attendance is taken each day and is part of your final grade.

**if you are sick, let us know (e-mail Jay and Neel) and stay home**.

Anticipated absences outside of sickness should be reported to the instructors of a given block well in advance.
