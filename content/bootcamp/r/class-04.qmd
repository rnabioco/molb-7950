---
title: "R Bootcamp - class 4"
author: "Sujatha Jagannathan"
---

## Learning Objectives for the R Bootcamp

.pull-left\[ \* .large\[Follow best coding practices\] \* .large\[Know the fundamentals of R programming\] \* .large\[Become familiar with "tidyverse" suite of packages\] \* tidyr: "Tidy" a messy dataset \* dplyr: Transform data to derive new information \* ggplot2: Visualize and communicate results \<-- *Class 4* \* .large\[Practice reproducible analysis\]\]
...
.large\[ \* Introduce *ggplot2* \* Review basic functions of *ggplot2* \* Homework instructions\] ---
