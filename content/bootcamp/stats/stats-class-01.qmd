...
1.  We can make an assumption of the underlying probability distribution - this gives us powerful tools to ask how different the size of two cell types are.
