...
#| fig.alt: "Side-by-side jitter plots of weight by sex: the left panel marks only the overall mean weight in red, the right adds blue diamonds at each sex-specific mean."
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Jittered points of weight by sex colored by residual on a blue-black-yellow scale, with a grey line at the overall mean and red segments at each sex-specific mean."
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Jittered points of weight by sex colored by deviation from the overall mean, with a grey line at that mean."
...
```{r}
#| echo: true
#| fig.alt: "Side-by-side comparison of weight by sex, colored by residual from the sex model on the left and by deviation from the overall mean on the right."

plot_grid(
  p_ws,
  p_w,
  ncol = 2,
  labels = c("weight by sex", "weight by intercept")
)
```
...
b_ws |>
  filter(
    subject_name %in% c("A048054885", "A067109771", "A066822351", "A048274362")
  ) |>
...
#| echo: true
#| output-location: slide
#| fig.alt: "Jittered points of weight for each of four mouse families, colored by family."
...
#| echo: true
#| output-location: slide
#| fig.alt: "Jittered points of weight by family colored by residual, with red segments at each family mean and a black segment at the overall mean."
...
#| echo: true
#| output-location: slide
#| fig.alt: "Scatter plot of weight against age colored by sex, with a separate fitted linear regression line and confidence band for each sex."
