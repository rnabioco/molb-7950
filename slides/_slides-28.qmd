...
#| label: explore-gene
#| output-location: column-fragment
#| fig.alt: "Histogram of the number of HuR binding sites per gene on a log10 scale, filled by transcript region."
...
#| label: target-not
#| output-location: column-fragment
#| fig.alt: "Empirical cumulative distribution of log2 fold change in mature mRNA for HuR targets versus non-targets, with grey reference lines at the 25th, 50th, and 75th percentiles."
...
#| label: target-quant
#| output-location: column-fragment
#| fig.alt: "Empirical cumulative distribution of log2 fold change in mature mRNA, colored by binned number of HuR binding sites in the 3' UTR, with dashed reference lines at the 25th, 50th, and 75th percentiles."
