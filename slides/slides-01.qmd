...
## A note on R vs Python

![](../img/tidy-workflow.png)

You will probably hear people say that one of R/Python is better than the other.

**This is merely an opinion**. Both languages are useful for different tasks, and both have their strengths and weaknesses.

We used to teach a mixture of shell, R, and Python in this course, but found that most students
left feeling like they didn't have a solid foundation in any of the approaches.

We teach R because:

- The tidyverse is a powerful and easy-to-use set of packages for data science.
- It is the language of jhoice for many biologists and statisticians, so
  you are likely to see R code in the wild and may need to understand it.
