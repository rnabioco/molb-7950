...
* Instructors (Matthew Taliaferro and Srinivas Ramachandran)

* TAs (Kate Matlin and Kiarra Coger)
...
We will spend time later in the course using LLMs to generate code in both R and Python (maybe).
