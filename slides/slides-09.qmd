...
![Cross-section of female nematode worm Ascaris](/img/ascaris_section.jpg){width="1483"}
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Jittered points of the mean of each run of coin flips for fair and cheating conditions, with grey diamonds at the group means and dashed reference lines at the true probabilities of 0.5 and 0.2."
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Jittered points of the mean of five rounds of fifty coin flips for fair and unfair coins, with black diamonds at the group means and dashed lines at the true probabilities of 0.5 and 0.2."
...
#| fig.alt: "Line plot of the estimated probability of winning the Monty Hall game against iteration number, with the switch strategy converging near two-thirds and the stick strategy near one-third, each labelled."
...
![](https://static.wixstatic.com/media/124541_774512bfbf7940d4baeacd30183316a6~mv2.png/v1/fill/w_471,h_362,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/eugenics%20tree.png){fig-align="right" width="500"}

### "Eugenics is broadly defined as the use of selective breeding to improve the human race."

-   [Unfit to Breed: America’s Dark Tale of Eugenics](https://irp.nih.gov/catalyst/29/4/unfit-to-breed-americas-dark-tale-of-eugenics)

-   [Eugenics and Scientific Racism - NIH](https://www.genome.gov/about-genomics/fact-sheets/Eugenics-and-Scientific-Racism)

-   [Stanford Eugenics History Project](https://www.stanfordeugenics.com/what-is-eugenics)

![](https://www.thelancet.com/cms/attachment/e1575255-3cc3-4d3d-8cc5-e500d05aec61/fx1.jpg){fig-align="left" width="500"}
