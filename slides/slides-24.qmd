...
pluripotencygenes <- filter(pathwaygenes, path == 'pluri') %>% pull(., ensembl_gene_id)
cellcyclegenes <- filter(pathwaygenes, path == 'cellcycle') %>% pull(., ensembl_gene_id)
neurongenes <- filter(pathwaygenes, path == 'neuron') %>% pull(., ensembl_gene_id)
```
