...
metadata <- data.frame(
  sample_id = list.files(here("data/block-rna/salmonouts"), pattern = "^DIV"),
  salmon_dirs = list.files(here("data/block-rna/salmonouts"), recursive = T, pattern = "quant.sf", full.names = T)
) |>
