...
#| fig.alt: "Four scatter plots of diamond price against carat contrasting where the color aesthetic is declared: in the top-level mapping versus inside a geom, and how that changes whether the smooth line is split by cut."
...
```{r}
#| label: piping_data
#| fig.alt: "Scatter plot of price against carat with points colored by cut and a single smoothed trend line fitted across all the data."
ggplot(
  diamonds_subset,
  aes(x = carat, y = price)
) +
...
```{r}
#| label: single-color
#| fig.alt: "Scatter plot of price against carat with all points a single red color and one smoothed trend line."
