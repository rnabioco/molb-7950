...
knitr::include_graphics(here("img/ggplot2/ggplot-syntax.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-aesthetics.png"))
```
...
knitr::include_graphics(here("img/ggplot2/ggplot-layers.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-1variable.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-geom-dx-cy.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-geom-cx-cy.png"))
```
...
```{r, echo = FALSE, out.width= '50%'}
knitr::include_graphics(here("img/ggplot2/ggplot-geom-cont-bivar.png"))
```
...
knitr::include_graphics(here("img/ggplot2/ggplot-shapes.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-position.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-facet.png"))
```
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot2/ggplot-themes.png"))
```
...
```{r, echo = FALSE, out.width= '50%'}
knitr::include_graphics(here("img/ggplot2/ggplot-labels-legends.png"))
```
