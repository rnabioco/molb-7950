...
#| fig.alt: "An empty ggplot canvas with no axes or data, produced by calling ggplot() with data only."
...
#| fig.alt: "An empty ggplot panel with carat on the x axis and price on the y axis, with no geom layer yet."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| output-location: slide
#| code-line-numbers: "8"
#| fig.alt: "Scatter plot of diamond price against carat, showing price rising steeply with carat."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| fig.alt: "Scatter plot of diamond price against carat, with points colored by cut and sized by carat."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| fig.alt: "Scatter plot of diamond price against carat, colored by cut and sized by carat, with points made semi-transparent to reveal overplotting."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: slide
#| fig.alt: "Console output from summary() describing the stored ggplot object's mapping, faceting, and layers rather than a rendered plot."
p <- ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| fig.alt: "Histogram of diamond carat, showing a right-skewed distribution with spikes at common round carat values."
ggplot(
  diamonds,
  aes(x = carat)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Bar chart of the number of diamonds in each cut category, with Ideal the most common."
ggplot(
  data = diamonds,
  mapping = aes(x = cut)
) +
...
#| fig.alt: "Stacked bar chart of diamond counts by cut, with each bar split and colored by clarity."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| output-location: column-fragment
#| code-line-numbers: "5"
#| fig.alt: "Density curve of diamond carat, right-skewed with bumps at popular carat sizes."
ggplot(
  data = diamonds,
  mapping = aes(x = carat)
) +
...
#| output-location: column-fragment
#| code-line-numbers: "5"
#| fig.alt: "Density curve of diamond carat filled with a solid tomato color."
ggplot(
  data = diamonds,
  mapping = aes(x = carat)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Overlapping semi-transparent density curves of diamond carat, one per cut category."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| fig.alt: "Ridgeline plot of diamond carat distributions, one row per cut category, each filled a different color."
ggplot(
  data = diamonds,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Bar chart of total diamond price summed within each cut category."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Box plots of diamond price for each cut category, showing medians, quartiles, and many high-price outliers."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Box plots of diamond price by cut, with each box filled a different color."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Violin plots of diamond price by cut, showing the full price distribution within each category."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat for a 1000-diamond sample, colored by cut."
ggplot(
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Smoothed conditional-mean curves of price against carat, one per cut, with confidence bands and no underlying points."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: slide
#| fig.alt: "Scatter plot of price against carat colored by cut, overlaid with a smoothed trend line per cut."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Small square scatter plot of diamond price against carat."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Hexagonal binning of price against carat, with fill showing the number of diamonds per hexagon."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat using white-outlined triangles, filled by cut and sized by depth."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Stacked bar chart of diamond counts by cut, colored by clarity."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Grouped bar chart of diamond counts by cut, with clarity categories placed side by side instead of stacked."
ggplot(
  data = diamonds,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat with the x axis transformed to a log10 scale after the data were plotted."
ggplot(
  diamonds_subset,
  aes(carat, price)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat with carat mapped onto a log10 scale, spreading the low-carat points out."
ggplot(
  diamonds_subset,
  aes(carat, price)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Bar chart of diamond counts by cut with vertical bars."
ggplot(
  data = diamonds,
  mapping = aes(x = cut)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Bar chart of diamond counts by cut with the coordinate system flipped, giving horizontal bars."
ggplot(
  data = diamonds,
  mapping = aes(x = cut)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price scaled by 1.32 against log10 carat, transforming the variables inside aes()."
ggplot(
  data = diamonds_subset,
  aes(
    x = log10(carat),
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat with semi-transparent points and the axes limited to 0-2 carat and 0-5000 in price."
ggplot(
  diamonds_subset,
  aes(carat, price)
) +
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Overlapping semi-transparent density curves of carat, one per cut, drawn in a wide panel."
ggplot(
  data = diamonds,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Density curves of log price faceted into a single row of panels, one per cut category."
ggplot(
  data = diamonds,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plots of price against carat faceted into a single row, one panel per cut, with very transparent points."
ggplot(
  data = diamonds,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of price against carat colored by cut, using ggplot's default grey theme."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| output-location: column-fragment
#| code-line-numbers: "10"
#| fig.alt: "The same price-against-carat scatter plot restyled with theme_bw, giving a white background and black border."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| output-location: column-fragment
#| code-line-numbers: "10"
#| fig.alt: "The same price-against-carat scatter plot restyled with theme_cowplot."
ggplot(
  data = diamonds_subset,
  mapping = aes(
    x = carat,
...
#| fig.alt: "Box plots of log price by cut, filled by cut, with title, subtitle, caption, and axis labels supplied via labs()."
ggplot(
  data = diamonds,
  mapping = aes(
    x = cut,
...
#| fig-height: 3
#| fig-width: 4
#| fig.alt: "A sequence of scatter plots of price against carat, each adding a different reference layer: connecting lines, a horizontal line at 5000, a vertical line at 2 carat, a linear fit, and a sloped reference line."
p <- ggplot(
  data = diamonds_subset,
  mapping = aes(x = carat, y = price, color = cut)
) +
