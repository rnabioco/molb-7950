...
#| echo: false
tibble(
  "Info" = c("better descriptor", "# of samples (N)"),
  "Parametric" = c("mean", "many"),
  "Nonparametric" = c("median  ", "few")
) |>
  gt()
```
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "An empty panel crossed by a red straight line with intercept 1 and slope 2, illustrating a linear relationship."
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "The same red line with intercept 1 and slope 2, drawn in a small square panel."
...
```{r}
#| fig.alt: "Scatter plot of weight against total cholesterol, showing a diffuse positive association."
ggplot(
  data = b,
  aes(
    y = weight,
...
```{r}
#| fig.alt: "Scatter plot of weight against total cholesterol with a fitted linear regression line and confidence band."
ggplot(
  data = b,
  aes(
    y = weight,
...
```{r}
#| fig.alt: "Scatter plot of weight against total cholesterol with the fitted regression line in red, points colored by residual on a blue-black-yellow scale, and vertical segments joining each point to its fitted value."
ggplot(
  data = b_WvC,
...
```{r}
#| fig.alt: "Scatter plot of weight against total cholesterol with a red horizontal line at the mean weight, points colored by deviation from that mean, and segments joining each point to the mean."
...
There is a `r 100*round(rsq,2)`% reduction in the variance when we take mouse $cholesterol$ into account\
OR\
$cholesterol$ explains `r 100*round(rsq,2)`% of variation in mouse $weight$
...
#| echo: true
#| output-location: slide
#| fig.alt: "Scatter plot of total cholesterol against weight for two permutations of the data, colored by permutation, showing the association destroyed by shuffling."
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Density curve of the F statistics obtained from 100 permutations, drawn in red."
...
remember that the $F-statistic$ we observed was \~`r round(f)`!

```{r}
#| echo: true
#| output-location: slide
#| fig.alt: "Density curve of the permuted F statistics in red with a blue vertical line marking the observed F statistic far out in the tail."
