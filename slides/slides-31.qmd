...
## Create a SingleCellExperiment object `r emo::ji("keyboard")`
...
## Storing gene identifiers `r emo::ji("keyboard")`
...
## Updating our rownames `r emo::ji("keyboard")`
