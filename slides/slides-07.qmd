...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Box plots of highway fuel economy for each vehicle class, in the default alphabetical class order."
ggplot(
  mpg,
  aes(
    x = class,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Box plots of highway fuel economy by vehicle class, with classes reordered by median so the trend reads left to right."
ggplot(
  mpg,
  aes(
    x = fct_reorder(
...
#| fig.alt: "Scatter plot of horsepower against miles per gallon for the mtcars data, with points colored by cylinder count."
p <- ggplot(
  mtcars,
  aes(
    x = mpg,
...
#| echo: true
#| output-location: column-fragment
#| fig.alt: "Scatter plot of diamond price against carat colored by cut, with points connected by lines."
...
#| fig.alt: "A two-by-two grid of the same scatter plot repeated four times, labelled A, B, C and D."
...
#| echo: true
#| output-location: slide
#| fig.alt: "A two-by-two grid of the same scatter plot labelled A to D, with a single shared legend placed underneath the panels."
