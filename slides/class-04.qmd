...
## ggplot powerfully simple for making complex plots
...
```{r fig.height=3, fig.width=4}
#| echo: true
#| output-location: column-fragment1yy
ggplot(
  data = diamonds_subset,
  mapping = aes(x = carat, y = price, color = cut)
) +
...
```{r, echo = FALSE, out.width= '60%'}
knitr::include_graphics(here("img/ggplot-position.png"))
```
