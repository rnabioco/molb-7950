...
🗓️ Class will run from Aug 24 - Oct 28
...
Classes begin on August 24 and end on October 28. Dates are from the
[Fall 2026 Academic
Calendar](https://www.cuanschutz.edu/registrar/academic-calendars/).
...
Classes will be held in-person in a variety of different rooms. Please check 
the schedule page to see each class's room assignment. All classes will be
...
**if you are sick, please let us know (e-mail Srinivas and Matt) and STAY 
HOME**.
...
students bring to this class is a resource, strength, and benefit.
...
ChatGPT et al will probably be able to answer most coding questions you ask of it.
While it is useful for fleshing out an initial approach from pseudocode,
we do not recommend using it, as these conceptual approaches are an essential foundation for building expertise in bioinformatic analysis.
...
-   You can discuss the content of assignments with others in this
    ...
    the top of your assignment, for example: "Collaborators: Bert and
    Ernie". Failure to acknowledge collaborators will result in a grade
...
- Matthew Taliaferro contributed material for the RNA block, including lecture material and examples for RNA expression and splicing analysis.
...
The University of Colorado honors and recognizes the many contributions of Indigenous peoples in our state.
The University of Colorado acknowledges that it is located on the traditional territories and ancestral homelands of the Cheyenne, Arapaho, Ute
...
While the University of Colorado can never undo or rectify the devastation wrought on Indigenous peoples, we commit to
improving and enhancing engagement with Indigenous peoples and issues locally and globally.
