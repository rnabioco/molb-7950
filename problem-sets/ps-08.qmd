---
title: "R Bootcamp Problem Set 8"
...
Use the data files in the `data/bootcamp/` directory to answer the questions.
...
-   After specific time points (0, 4, 8, 12, 24 hours), cells were harvested and GAPDH and interferon mRNA were analyzed by quantitative PCR (with 3 biological replicates, and 3 technical replicates).
...
- `data/bootcamp/qpcr_names_ps.tsv.gz`
- `data/bootcamp/qpcr_data_ps.tsv.gz`
