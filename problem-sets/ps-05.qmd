...
If you submit an entry, you get full credit on the problem set. Entries will be anonymized and winners will selected by popular vote.
...
#| message: false
#| warning: false
#| fig.alt: "Scatter plot of bill length against body mass for the palmer penguins, faceted by island, with color showing species and point shape showing sex."
library(tidyverse)
...
```{r}
#| label: yikes_ozekin
#| fig.alt: "A deliberately awful Titanic plot: jittered counts of survival on a square-root y axis, over a dark blue background with clashing rotated axis text, a rotated green title, and a yellow legend, used as an example of what not to do."
library(tidyverse)
...
#| label: anyene
#| warning: false
#| fig.alt: "A polar-coordinate generative art piece: three semi-transparent wedges in navy, red and orange radiating from a common center over a cream background, with black outline segments and an artist credit caption."
library(tidyverse)
