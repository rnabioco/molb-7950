...
The three single cell RNA-seq datasets have already been preprocessed and QC'd. There is an `.rds` file (`data/block-rna/scrna/aml/d0_d2_d4_filtered.rds`) provided that contains the combined samples in a single seurat object. We will use this seurat object for this homework. 
