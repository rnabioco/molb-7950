...
1. Read the two papers in the [preparation](prepare/prepare-16.qmd) document before class on Wed.
...
3. Use `bed_map()` to calculate the total (i.e., summed) DNase I signal in the promoters (using the `value` column in the DNase file).
